...
def esd(path):
	try:
		...
		log.log(' [ Toolsdata Error ] esd: ' + str(e))
...
def subdomainbrute(path):
	try:
		...
		log.log(' [ Toolsdata Error ] subdomainbrute: ' + str(e))
...
def aquatone(path):
	try:
		...
		log.log(' [ Toolsdata Error ] aquatone: ' + str(e))
...
def fierce(path):
	try:
		...
		log.log(' [ Toolsdata Error ] fierce: ' + str(e))
...
def findomain(path):
	try:
		...
		log.log(' [ Toolsdata Error ] findomain: ' + str(e))
...
def chaos(path):
	try:
		...
		log.log(' [ Toolsdata Error ] chaos: ' + str(e))
...
def github_subdomains(path):
	try:
		...
		log.log(' [ Toolsdata Error ] github_subdomains: ' + str(e))
...
def knock(path):
	try:
		...
		log.log(' [ Toolsdata Error ] knock: ' + str(e))
...
def dnsmap(path):
	try:
		...
		log.log(' [ Toolsdata Error ] dnsmap: ' + str(e))
...
def ksubdomain(path):
	try:
		...
		log.log(' [ Toolsdata Error ] ksubdomain: ' + str(e))
...
def subfinder(path):
	try:
		...
		log.log(' [ Toolsdata Error ] subfinder: ' + str(e))
...
def dnsub(path):
	try:
		...
		log.log(f"[ Toolsdata Error ] dnsub: " + str(e))
...
def tools(ROOT):
	try:
		...
		log.log(' [ Toolsdata Error ] Tools: ' + str(e))
...
def main(r_path):
	...
	try:
		...
		log.log(' [ Toolsdata Error ]  Main: ' + str(e))
